...
public class EntityRegistry{
    ...
    public static final RegistryObject<EntityType<EntityIgloof>> IGLOOF = ENTITY_REG.register("igloof", () -> EntityType.Builder.of(EntityIgloof::new, EntityClassification.CREATURE).sized(0.6F, 0.85F).clientTrackingRange(10).build("igloof"));
