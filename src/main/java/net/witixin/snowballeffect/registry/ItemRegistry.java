...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> MAGIC_TORCH_ITEM = ITEM_REG.register("magic_torch",() -> new WallOrFloorItem(BlockRegistry.MAGIC_TORCH.get(), BlockRegistry.WALL_MAGIC_TORCH.get(), new Item.Properties()));
